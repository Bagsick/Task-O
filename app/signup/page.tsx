        ...
        {success ? (
          <>
            <div className="text-center mb-6">
              <Link href="/landing" className="inline-flex items-center justify-center w-12 h-12 bg-green-500 rounded-xl mb-3 transition-opacity hover:opacity-80"
                style={{ boxShadow: '0 4px 20px rgba(34,197,94,0.35)' }}>
                <CheckCircle className="h-7 w-7 text-white" />
              </Link>
              <h1 className="text-2xl font-bold text-gray-900">Check your email</h1>
              <p className="text-gray-500 text-sm mt-1">A confirmation link has been sent</p>
            </div>
          ...
          <>
            ...
            <div className="text-center mb-5">
              <Link
                href="/landing"
                className="inline-flex items-center justify-center w-12 h-12 bg-[#0052CC] rounded-xl mb-3 transition-all hover:scale-105 hover:brightness-110"
            ...
            <div className="rounded-2xl p-5 relative"
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 py-2 text-sm font-medium text-gray-600 rounded-lg transition-all hover:text-gray-800"
                style={{
